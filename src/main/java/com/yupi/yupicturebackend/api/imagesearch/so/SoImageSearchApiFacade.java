package com.yupi.yupicturebackend.api.imagesearch.so;

import com.yupi.yupicturebackend.api.imagesearch.so.model.SoImageSearchResult;
import com.yupi.yupicturebackend.api.imagesearch.so.sub.GetSoImageListApi;
import com.yupi.yupicturebackend.api.imagesearch.so.sub.GetSoImageUrlApi;
...
public class SoImageSearchApiFacade {
    ...
    public static void main(String[] args) {
        // 测试以图搜图功能
        String imageUrl = "https://sphz-1390064104.cos.ap-guangzhou.myqcloud.com/public/1994231653706362881/2026-03-09_Org7eKBwwfwFw8le.jpg";
